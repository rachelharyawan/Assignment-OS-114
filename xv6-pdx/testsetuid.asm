...
main(int argc, char *argv[])
{
  ...
  23:	6a 01                	push   $0x1
  25:	e8 1c 04 00 00       	call   446 <printf>
  exit();
...
putc(int fd, char c)
{
 ...
 3b3:	52                   	push   %edx
 3b4:	50                   	push   %eax
 3b5:	e8 2b ff ff ff       	call   2e5 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f9:	0f b6 92 28 07 00 00 	movzbl 0x728(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 54a:	75 28                	jne    574 <printf+0x12e>
          s = "(null)";
 54c:	be 20 07 00 00       	mov    $0x720,%esi
...
morecore(uint nu)
{
 ...
 646:	50                   	push   %eax
 647:	e8 01 fd ff ff       	call   34d <sbrk>
  if(p == (char*)-1)
